...
function buildMidjourneyPrompt(slot, { aspect = "16:9", tone = "realism", people = "none" } = {}) {
  ...
  /* 전역 블러 절대 금지 — 전 장르 공통 */
  if (!isIllust) neg += ", blur, blurry, blurred background, bokeh, shallow depth of field, out of focus, soft focus";
  const params = [];
